    ...
    <div id="content" style="margin-top: 55px;">
        ...
        <div style="display: none;">
            <a href="#" class="slide-img">
                <img id="Img1" class="img-slide" src="../images/slide_promotion/promotion_slid1.png" alt="promotion 1" title="promotion 1" />
            </a>
        ...
        <div id="Div1" class="service-box divider-content" style="border-bottom: 1px solid #ccc;">
            ...
            <div class="row">
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-01.png" height="100" width="100" />
                    <h3>อุบัติเหตุที่เกิดจากการชน</h3>
                    <p>ดูแลคุณและรถของคุณ เมื่อเกิดอุบัติเหตุที่ไม่เกี่ยวข้องกับรถยนต์คันอื่น ความคุ่มครองนี้สำหรับประกันชั้น 1 เท่านั้น</p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-02.png" height="100" width="100" />
                    <h3>อุบัติเหตุรถชนรถ</h3>
                    <p>คุ้มครองความเสียหายจากอุบัติเหตุบนถนนที่เกิดจากรถชนกับรถที่มีป้ายทะเบียน</p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-03.png" height="100" width="100" />
                    <h3>บริการรถลาก 24 ชั่วโมง</h3>
                    <p>เราพร้อมให้บริการรถลากตลอด 24 ชั่วโมงเพื่อคอยช่วยเหลือคุณในยามฉุกเฉิน</p>
                </div>
            </div>
            <div class="row">
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-04.png" height="100" width="100" />
                    <h3>รถหาย</h3>
                    <p>เราคุ้มครองในกรณีรถหายและยังมีความคุ้มครองพิเศษที่คุ้มครองทรัพย์สินภายในรถ เพื่อชดเชยความเสียหายของทรัพย์สินที่ถูกขโมย</p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-05.png" height="100" width="100" />
                    <h3>ภัยธรรมชาติ</h3>
                    <p>เมื่อเกิดภัยธรรมชาติ หมดห่วงได้เลยเพราะเราคุ้มครองความเสียหายต่อตัวรถที่เกิดขึ้นในทุกพื้นที่ที่ทั่วประเทศไทย</p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-06.png" height="100" width="100" />
                    <h3>ภัยก่อการร้าย</h3>
                    <p>ภัยที่ทุกคนไม่อยากให้เกิดขึ้น แต่บางครั้งก็ยากที่จะคาดเดา เราให้ความคุ้มครองรถคุณจากผลกระทบของภัยก่อการร้าย</p>
                </div>
            </div>
            <div class="row">
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-07.png" height="100" width="100" />
                    <h3>รถไฟไหม้</h3>
                    <p>
                        เมื่อเกิดเหตุการ์ณไฟไหม้รถไม่ต้องกังวลความคุ้มครองของประกันรถชั้น 1 และชั้น 2+ ช่วยดูแลคุณเสมอได้
                    </p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-08.png" height="100" width="100" />
                    <h3>รถน้ำท่วม</h3>
                    <p>
                        เมื่อรถถูกน้ำท่วม งานซ่อมเป็นเรื่องใหญ่ สบายใจกว่าไหม? ให้เราช่วยดูแลความเสียหายของรถคุณ
                    </p>
                </div>
                <div class="col-mb-9 col-dt-4 txt-center">
                    <img src="../images/biology/service-09.png" height="100" width="100" />
                    <h3>ความคุ้มครองสูง</h3>
                    <p>นอกจากความคุ้มครองตามกรมธรรม์แล้วเราสามารถเลือกความคุ้มครองเสริมที่ตรงกับความต้องการของตัวคุณได้อีกด้วย</p>
                </div>
            </div>
        </div>

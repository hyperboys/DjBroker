function CarModel(carbrandid){
    ...
    var answer = document.getElementById("categories_insurance_year");
    var caryear = answer[answer.selectedIndex].value
    var answer2 = document.getElementById("categories_insurance_year");
    carbrandid = answer[answer.selectedIndex].value
    var answer3 = document.getElementById("categories_insurance_year");
    var caryear = answer[answer.selectedIndex].value
